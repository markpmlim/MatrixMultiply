...
The assembly source code was originally written for the LInux OS and assembled with GAS (gnu as). The default assembler on macOS is a version of GAS. Out-of-the-Box,  XCode has good support for debugging  GAS assembly programs written in AT&T and Intel synax.
